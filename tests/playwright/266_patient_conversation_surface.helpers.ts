...
export const ATLAS_PATH = "/docs/frontend/266_patient_conversation_surface_atlas.html";
...
export async function startStaticServer(): Promise<{ server: http.Server; atlasUrl: string }> {
  const port = await allocatePort();
...
export async function openPatientRoute(page: any, url: string, testId = "PatientConversationRoute"): Promise<void> {
