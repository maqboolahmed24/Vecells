  ...
  retry_classes: [
    {
      ...
      description:
        "Repeat the read-only step when the target is unchanged and the evidence snapshot is refreshed.",
      completion_evidence_rule: "A fresh gate snapshot or official label match proves completion.",
      insufficient_evidence_rule:
        "Page load, HTTP 200, or button visibility alone are insufficient.",
      idempotent: true,
      max_auto_retries: 2,
    ...
    },
    {
      ...
      description:
        "Do not rerun the whole path. Resume from the last stable draft or checkpoint receipt.",
      completion_evidence_rule:
        "A stable draft id or checkpoint receipt proves where resume may start.",
      insufficient_evidence_rule:
        "Filling the same fields again without a checkpoint token is insufficient.",
      idempotent: false,
      max_auto_retries: 0,
    ...
    },
    {
      ...
      description:
        "Stop after assembling the evidence pack and wait for a named reviewer before any further mutation.",
      completion_evidence_rule:
        "A named review reference tied to the next intended mutation proves completion.",
      insufficient_evidence_rule:
        "Internal confidence or green UI state without reviewer identity is insufficient.",
      idempotent: false,
      max_auto_retries: 0,
    ...
    },
    {
      ...
      description:
        "Capture the minimum safe proof, then stop so a human completes or reviews the external action.",
      completion_evidence_rule:
        "A safe evidence bundle and handoff record prove the automation did enough.",
      insufficient_evidence_rule:
        "A screenshot without approval context or redaction proof is insufficient.",
      idempotent: false,
      max_auto_retries: 0,
    ...
    },
    {
      ...
      description:
        "Submitting again risks duplicate provider state, duplicate spend, or duplicate onboarding. Never auto-repeat.",
      completion_evidence_rule:
        "Only the first provider receipt or ticket id can prove completion.",
      insufficient_evidence_rule:
        "Button-click success or page refresh after submit are insufficient.",
      idempotent: false,
      max_auto_retries: 0,
    ...
    },
    {
      ...
      description:
        "The step handles secret material. Captures are allowed only when redaction is proven and approved.",
      completion_evidence_rule:
        "A vault receipt or quarantined masked evidence handle proves completion.",
      insufficient_evidence_rule:
        "Clipboard copies, raw traces, HAR files, or unmasked screenshots are insufficient.",
      idempotent: false,
      max_auto_retries: 0,
  ...
  idempotency_classes: [
    {
      ...
      label: "Read only",
      description:
        "No external mutation. Re-running fetches or labels is safe when evidence snapshots stay fresh.",
      rank: 1,
    },
    {
      ...
      description:
        "A partially completed draft can be resumed from the same checkpoint, but not blindly restarted from scratch.",
      rank: 2,
    },
    {
      ...
      description:
        "The step can be revisited only after a named reviewer confirms the evidence pack still matches the intended mutation.",
      rank: 3,
    },
    {
      ...
      description:
        "Submitting twice may create duplicate provider state, duplicate approvals, spend, or conflicting onboarding requests.",
      rank: 4,
    },
    {
      ...
      description:
        "Secrets or vault-bound evidence are in scope, so capture and retry rules are stricter than ordinary form mutation.",
      rank: 5,
    },
  ],
  evidence_classes: [
    {
      ...
      label: "Gate snapshot",
      description:
        "A dated evidence snapshot showing the current blocked/review/pass state for a read-only step.",
      rank: 1,
    },
    {
      ...
      description:
        "A draft identifier, stage receipt, or structured review note that proves the step can be resumed safely.",
      rank: 2,
    },
    {
      ...
      description:
        "A named approval, legal, signatory, or governance reference tied to the current intended mutation.",
      rank: 3,
    },
    {
      ...
      description:
        "A supplier ticket, mailbox ID, or purchase/reference proving the provider accepted the exact action once.",
      rank: 4,
    },
    {
      ...
      label: "Vault receipt",
      description:
        "A masked evidence handle proving secret capture or vault promotion without leaking the underlying secret.",
      rank: 5,
    },
  ],
  approval_lanes: [
    {
      ...
      description:
        "Legal basis, governance approval, or feature-flag review before the step can widen beyond mock posture.",
    },
    {
      lane_id: "sponsor_commercial",
      label: "Sponsor / commercial",
      description:
        "Named sponsor, commissioner, or commercial owner confirms the bounded MVP and supplier posture.",
    },
    {
      lane_id: "signatory",
      label: "Signatory",
      description:
        "Human-only legal or organisational signatory handoff outside the repo and outside browser automation.",
    },
    {
      lane_id: "environment_approval",
      label: "Environment approval",
      description:
        "A named approver binds the action to sandpit, integration, preprod, or production before mutation is allowed.",
    },
    {
      lane_id: "vendor_service_desk",
      label: "Vendor service desk",
      description:
        "Supplier-side mailbox, workflow, number, sender, or account steps need later human liaison or service-desk handling.",
    },
    {
      lane_id: "safety_privacy_assurance",
      label: "Safety / privacy assurance",
      description:
        "Hazard logs, risk logs, minimum-necessary review, or accessibility/service evidence must be current and approved.",
    },
    {
      lane_id: "ownership_rehearsal",
      label: "Ownership / rehearsal",
      description:
        "Operational ownership, incident path, or urgent manual fallback must be rehearsed before live widening.",
    },
  ],
  checkpoints: [
    {
      ...
      harness_paths: [
        "/Users/test/Code/V/tools/browser-automation/nhs-login-live-application-dry-run.spec.js",
        "/Users/test/Code/V/tools/browser-automation/nhs-login-credential-intake-dry-run.spec.js",
      ],
      selector_refs: [
      ...
      mock_now_execution:
        "Read labels and gate posture only. Stop before any real submission affordance.",
      actual_provider_strategy_later:
        "Use the same gate snapshot before the real partner request so later runs start from current evidence rather than stale assumptions.",
      completion_evidence: [
      ...
      redaction_policy:
        "Masked stills only. Never expose redirect URIs, emails, or client identifiers in raw captures.",
      max_auto_retries: 2,
      backoff_posture: "short_linear_backoff",
      screenshot_policy: "masked_stills_allowed",
      trace_policy: "trace_allowed_without_secrets",
      ...
      idempotent: true,
      source_refs: [
        "/Users/test/Code/V/data/analysis/nhs_login_capture_pack.json",
      ...
      evidence_freshness_window_days: 21,
    ...
    },
    {
      ...
      approval_lanes: ["Environment approval", "Safety / privacy assurance"],
      live_gate_status: "review_required",
      live_gate_ids: ["LIVE_GATE_REDIRECT_URI_REVIEW", "LIVE_GATE_TECHNICAL_CONFORMANCE_PENDING"],
      live_gate_titles: [
        "Redirect and environment review",
        "Technical conformance and regression pack",
      ],
      required_env: [
        "NHS_LOGIN_NAMED_APPROVER",
        "NHS_LOGIN_ENVIRONMENT_TARGET",
      ...
      selector_refs: ["cred_redirect_review_ref", "cred_scope_approval_ref"],
      summary:
        "Bind the redirect URI and scope pack to a named reviewer before any real registration step can proceed.",
      mock_now_execution:
        "Assemble the redirect matrix and review checklist, then stop for named approval.",
      actual_provider_strategy_later:
        "Later sandpit or live registration must reuse the same review reference and reject blind reruns.",
      completion_evidence: [
      ...
      redaction_policy:
        "Allow masked stills of the review pack only after route-specific identifiers are obscured.",
      max_auto_retries: 0,
      backoff_posture: "stop_and_queue_review",
      screenshot_policy: "masked_stills_only",
      trace_policy: "trace_disabled_by_default",
    ...
    },
    {
      ...
      retry_chip_label: "redacted_only",
      ...
      live_gate_titles: [
        "NHS login partner approval",
        "Environment target present",
        "Live mutation flag enabled",
      ],
      required_env: [
        "NHS_LOGIN_NAMED_APPROVER",
        "NHS_LOGIN_ENVIRONMENT_TARGET",
      ...
      selector_refs: ["cred_named_approver", "cred_environment_target", "cred_live_mutation_flag"],
      summary:
        "Handle client credentials or secret material only through masked capture and later vault receipts.",
      mock_now_execution:
        "Use placeholders and quarantine-first handling only; never store real secret values in repo outputs.",
      actual_provider_strategy_later:
        "The live step stays blocked until partner approval, environment target, and mutation approval are explicit.",
      completion_evidence: [
      ...
      redaction_policy:
        "Traces and HAR are off. Only masked stills with an explicit redaction approval reference are allowed.",
      max_auto_retries: 0,
      backoff_posture: "manual_secret_reentry_only",
      screenshot_policy: "redaction_proven_then_masked_stills_only",
      trace_policy: "trace_off_har_off_console_scrubbed",
    ...
    },
    {
      ...
      provider_family_label: "GP systems / IM1",
      source_pack_key: "gp",
      source_pack_label: "GP systems / IM1",
      task_refs: ["seq_036"],
      stage: "read",
      retry_class: "safe_read_retry",
      retry_chip_label: "safe_read_retry",
      ...
      approval_lanes: ["Sponsor / commercial"],
      live_gate_status: "pass",
      live_gate_ids: [
      ...
      live_gate_titles: [
        "Provider path evidence is published",
        "Approved provider scorecards exist",
      ],
      required_env: [
        "ALLOW_REAL_PROVIDER_MUTATION",
        "GP_PROVIDER_ARCHITECTURE_DIAGRAM_REF",
        "GP_PROVIDER_BOOKING_MVP_REF",
        "GP_PROVIDER_DATAFLOW_DIAGRAM_REF",
        "GP_PROVIDER_ENVIRONMENT_TARGET",
        "GP_PROVIDER_NAMED_APPROVER",
        "GP_PROVIDER_SPONSOR_MODE",
        "GP_PROVIDER_WATCH_REGISTER_ACK",
      ],
      env_bindings: {
      ...
      harness_paths: [
        "/Users/test/Code/V/tools/browser-automation/gp-provider-path-discovery-dry-run.spec.js",
      ],
      selector_refs: ["row_im1_optum", "row_gpc", "row_bars"],
      summary:
        "Inspect the provider pathfinder and official label checks without opening a real supplier path.",
      mock_now_execution:
        "Use the pathfinder as a read-only proof surface and keep the live route closed.",
      actual_provider_strategy_later:
        "Re-run the same evidence review before any supplier claim so later automation starts from the current shortlist and path evidence.",
      completion_evidence: [
      ...
      redaction_policy:
        "Screenshots may be taken because no secret fields are involved, but route-specific tickets must still be masked.",
      max_auto_retries: 2,
      backoff_posture: "short_linear_backoff",
      screenshot_policy: "masked_stills_allowed",
      trace_policy: "trace_allowed_without_secrets",
      ...
      idempotent: true,
      source_refs: [
        "/Users/test/Code/V/data/analysis/gp_provider_decision_register.json",
    ...
    },
    {
      ...
      approval_lanes: ["Sponsor / commercial", "Signatory", "Safety / privacy assurance"],
      live_gate_status: "review_required",
      live_gate_ids: [
      ...
      live_gate_titles: [
        "Provider capability model frozen enough for submission",
        "Safety, privacy, DPIA, architecture, and data-flow artifacts current",
      ],
      required_env: [
        "IM1_NAMED_APPROVER",
      ...
      harness_paths: [
        "/Users/test/Code/V/tools/browser-automation/im1-prerequisites-dry-run.spec.js",
      ],
      selector_refs: [
        "actual-field-sponsor-name",
        "actual-field-commercial-owner",
        "actual-field-named-approver",
      ],
      summary:
        "Draft the prerequisite dossier only from the last saved checkpoint so sponsor placeholders and supplier evidence do not drift.",
      mock_now_execution:
        "Resume the mock dossier from the current placeholder-backed stage receipt.",
      actual_provider_strategy_later:
        "Later live drafting must use the same checkpoint model so supplier and assurance evidence stays versioned instead of retyped.",
      completion_evidence: [
      ...
      redaction_policy:
        "Allow masked draft screenshots only before commit and only when legal placeholders are still synthetic.",
      max_auto_retries: 0,
      backoff_posture: "no_blind_retry_resume_only",
      screenshot_policy: "masked_stills_allowed_before_commit",
      trace_policy: "trace_until_checkpoint_only",
      ...
      idempotent: false,
      source_refs: [
        "/Users/test/Code/V/data/analysis/im1_pairing_pack.json",
        "phase-4-the-booking-engine.md#4B Provider capability matrix and adapter seam",
        "phase-4-the-booking-engine.md#4E Commit path",
    ...
    },
    {
      ...
      approval_lanes: ["Sponsor / commercial", "Safety / privacy assurance"],
      live_gate_status: "blocked",
      live_gate_ids: [
      ...
      live_gate_titles: [
        "Credible MVP/demo and bounded IM1 use case",
        "Provider capability model frozen enough for submission",
      ],
      required_env: [
        "IM1_NAMED_APPROVER",
      ...
      summary:
        "Stop after assembling the supported-test request and wait for an admissibility review rather than replaying the flow.",
      mock_now_execution:
        "Compile the request pack and capture the evidence ladder that proves why the request is bounded and admissible.",
      actual_provider_strategy_later:
        "A live supported-test request must not proceed unless the same review reference is current.",
      completion_evidence: [
      ...
      redaction_policy:
        "Masked stills only. Legal names and supplier identifiers stay outside raw captures.",
      max_auto_retries: 0,
      backoff_posture: "stop_and_queue_review",
      screenshot_policy: "masked_stills_only",
      trace_policy: "trace_disabled_by_default",
    ...
    },
    {
      ...
      retry_chip_label: "capture_stop",
      idempotency_class: "review_checkpoint",
      evidence_class: "review_reference",
      approval_lane_ids: ["signatory", "sponsor_commercial"],
      approval_lanes: ["Signatory", "Sponsor / commercial"],
      live_gate_status: "blocked",
      live_gate_ids: [
      ...
      live_gate_titles: [
        "Named sponsor and commercial owner posture known",
        "Named approver present",
      ],
      required_env: [
        "IM1_NAMED_APPROVER",
        "IM1_ENVIRONMENT_TARGET",
      ...
      summary:
        "Collect the minimum masked proof that the legal handoff is ready, then stop before any signatory or legal mutation.",
      mock_now_execution: "Track signatory readiness and placeholder ownership only.",
      actual_provider_strategy_later:
        "A human-owned signatory chain completes the real handoff outside browser automation.",
      completion_evidence: [
      ...
      redaction_policy:
        "Only masked stills of role labels are allowed. No real legal names or signatory details appear in captures.",
      max_auto_retries: 0,
      backoff_posture: "stop_after_capture",
      screenshot_policy: "only_masked_approved_stills",
      trace_policy: "trace_off_har_off",
      ...
      source_refs: [
        ...
        "blueprint-init.md#1. Product definition",
        "seq_026",
        "ROLE_COMMERCIAL_OWNER",
        "provider_supplier_signatory",
      ],
      evidence_freshness_window_days: 30,
      live_gate_required: true,
    },
    {
      checkpoint_id: "CHK_008",
      ...
      retry_chip_label: "never_auto_repeat",
      ...
      approval_lanes: ["Signatory", "Environment approval", "Sponsor / commercial"],
      live_gate_status: "blocked",
      live_gate_ids: [
      ...
      live_gate_titles: [
        "External-readiness chain remains withheld",
        "Named approver present",
        "Environment target present",
        "ALLOW_REAL_PROVIDER_MUTATION=true explicitly set",
      ],
      required_env: [
        "IM1_NAMED_APPROVER",
        "IM1_ENVIRONMENT_TARGET",
      ...
      summary:
        "A real IM1 submission is a one-shot commit. Any ambiguity after submit goes to reconciliation, not replay.",
      mock_now_execution:
        "Dry-run stops before the final submit and records why the commit remains blocked.",
      actual_provider_strategy_later:
        "Later live submission requires a fresh provider receipt and never allows blind resubmission.",
      completion_evidence: [
      ...
      redaction_policy:
        "Commit-phase screenshots are disabled by default. If a still is required, it must be masked and approved before capture.",
      max_auto_retries: 0,
      backoff_posture: "manual_reconciliation_only",
      screenshot_policy: "no_commit_screenshots_without_approval",
      trace_policy: "trace_off_har_off",
    ...
    },
    {
      ...
      approval_lanes: ["Legal / governance", "Safety / privacy assurance"],
      live_gate_status: "review_required",
      live_gate_ids: [
      ...
      live_gate_titles: [
        "Exact access mode selected and justified",
        "Hazard log is current",
        "Risk logs are current for each access mode used",
      ],
      required_env: [
        "PDS_NAMED_APPROVER",
      ...
      harness_paths: [
        "/Users/test/Code/V/tools/browser-automation/pds-digital-onboarding-dry-run.spec.js",
      ],
      selector_refs: ["field_approver", "field_environment", "hazard_row", "risk_row"],
      summary:
        "Resume the route-bound PDS use-case pack from its last checkpoint rather than replaying the onboarding form.",
      mock_now_execution:
        "Keep the route flags default-off and resume the mock pack only from the current draft receipt.",
      actual_provider_strategy_later:
        "Later onboarding must reuse the checkpoint receipt so the legal basis, hazard log, and risk log stay aligned.",
      completion_evidence: [
      ...
      redaction_policy:
        "Masked draft captures are allowed, but patient-like identifiers and organisation details must stay synthetic or obscured.",
      max_auto_retries: 0,
      backoff_posture: "no_blind_retry_resume_only",
      screenshot_policy: "masked_stills_allowed_before_commit",
      trace_policy: "trace_until_checkpoint_only",
      ...
      idempotent: false,
      source_refs: [
        "/Users/test/Code/V/data/analysis/pds_access_pack.json",
    ...
    },
    {
      ...
      approval_lanes: ["Legal / governance", "Environment approval"],
      live_gate_status: "blocked",
      live_gate_ids: ["LIVE_GATE_PDS_LEGAL_BASIS_APPROVED", "PDS_LIVE_GATE_ROLLBACK_REHEARSED"],
      live_gate_titles: [
        "PDS legal basis and feature-flag approval",
        "Rollback and kill switch have been rehearsed",
      ],
      required_env: [
        "PDS_NAMED_APPROVER",
        "PDS_ENVIRONMENT_TARGET",
      ...
      summary:
        "Legal basis, feature-flag scope, and rollback posture require named review before any real PDS access can open.",
      mock_now_execution: "Model the legal basis and rollback questions, then stop for approval.",
      actual_provider_strategy_later:
        "Live access later reuses the same review posture and refuses any shortcut around legal sign-off.",
      completion_evidence: [
      ...
      redaction_policy:
        "Only masked stills of approval metadata are allowed. No patient or operator identifiers in captures.",
      max_auto_retries: 0,
      backoff_posture: "stop_and_queue_review",
      screenshot_policy: "masked_stills_only",
      trace_policy: "trace_disabled_by_default",
    ...
    },
    {
      ...
      approval_lanes: ["Vendor service desk", "Safety / privacy assurance"],
      live_gate_status: "review_required",
      live_gate_ids: [
      ...
      live_gate_titles: [
        "Mailbox owner ODS posture is known",
        "Third-party mailbox manager posture is decided",
        "Minimum-necessary payload and proof review is current",
      ],
      required_env: [
        "MESH_NAMED_APPROVER",
      ...
      harness_paths: ["/Users/test/Code/V/tools/browser-automation/mesh-mailbox-dry-run.spec.js"],
      selector_refs: [
        "mailbox_button",
        "field_owner_ods",
        "field_manager_mode",
        "field_workflow_contact",
      ],
      summary:
        "Resume the mailbox application from its last checkpoint so owner ODS and manager mode stay consistent.",
      mock_now_execution:
        "Populate the mock application pack and preserve the current receipt for safe resume.",
      actual_provider_strategy_later:
        "Live mailbox setup later must continue from the same bounded draft rather than replaying the whole application blindly.",
      completion_evidence: [
      ...
      redaction_policy:
        "Masked stills allowed before commit. ODS identifiers may appear only if the pack is still synthetic or approved.",
      max_auto_retries: 0,
      backoff_posture: "no_blind_retry_resume_only",
      screenshot_policy: "masked_stills_allowed_before_commit",
      trace_policy: "trace_until_checkpoint_only",
      ...
      idempotent: false,
      source_refs: [
        "/Users/test/Code/V/data/analysis/mesh_execution_pack.json",
        "blueprint-init.md#1. Product definition",
    ...
    },
    {
      ...
      approval_lanes: ["Vendor service desk", "Environment approval"],
      live_gate_status: "blocked",
      live_gate_ids: [
      ...
      live_gate_titles: [
        "Current-baseline external readiness gate cleared",
        "Live API onboarding is complete for any live API mailbox request",
        "Named approver and environment target are present",
        "Real mutation and spend acknowledgements are enabled",
      ...
      summary:
        "A MESH workflow request is a non-idempotent provider mutation. Submit exactly once or escalate to human reconciliation.",
      mock_now_execution: "Dry-run completes the draft and stops before final request submission.",
      actual_provider_strategy_later:
        "The real request later must capture one workflow receipt and must never be replayed automatically.",
      completion_evidence: [
      ...
      redaction_policy:
        "Commit-phase capture is disabled unless a masked still is explicitly approved for the evidence pack.",
      max_auto_retries: 0,
      backoff_posture: "manual_reconciliation_only",
      screenshot_policy: "no_commit_screenshots_without_approval",
      trace_policy: "trace_off_har_off",
    ...
    },
    {
      ...
      provider_family_label: "Telephony",
      source_pack_key: "telephony",
      source_pack_label: "Telephony",
      task_refs: ["seq_032"],
      stage: "fill",
      retry_class: "resume_from_checkpoint_only",
      retry_chip_label: "resume_only",
      ...
      harness_paths: [
        "/Users/test/Code/V/tools/browser-automation/telephony-account-and-number-dry-run.spec.js",
      ],
      selector_refs: [
        "field_vendor",
        "field_recording_policy",
        "field_number_profile",
        "field_secret_ref",
      ],
      summary:
        "Resume telephony project setup from the last draft so webhook, recording, and spend posture stay in one evidence bundle.",
      mock_now_execution: "Populate the dry-run form and keep the real submit button disabled.",
      actual_provider_strategy_later:
        "Later real setup continues from the checkpoint receipt and still requires the same recording and webhook pack.",
      completion_evidence: [
      ...
      redaction_policy:
        "Masked draft captures only. Secret refs may appear only as vault handles, never raw secrets.",
      max_auto_retries: 0,
      backoff_posture: "no_blind_retry_resume_only",
      screenshot_policy: "masked_stills_allowed_before_commit",
      trace_policy: "trace_until_checkpoint_only",
      ...
      idempotent: false,
      source_refs: [
        "/Users/test/Code/V/data/analysis/32_telephony_lab_pack.json",
      ...
      evidence_freshness_window_days: 14,
      live_gate_required: true,
    },
    {
      checkpoint_id: "CHK_014",
      ...
      approval_lanes: ["Environment approval", "Vendor service desk"],
      live_gate_status: "blocked",
      live_gate_ids: [
      ...
      summary:
        "Buying or binding a number can create spend and external state. Never auto-repeat after commit.",
      mock_now_execution:
        "The dry-run script must stop with the provider submit disabled while Phase 0 remains withheld.",
      actual_provider_strategy_later:
        "A live number purchase later requires one provider receipt and explicit spend authority.",
      completion_evidence: [
      ...
      redaction_policy:
        "No unapproved commit-phase captures. Any evidence still must mask account identifiers and numbers until the receipt is archived safely.",
      max_auto_retries: 0,
      backoff_posture: "manual_reconciliation_only",
      screenshot_policy: "no_commit_screenshots_without_approval",
      trace_policy: "trace_off_har_off",
    ...
    },
    {
      ...
      provider_family_label: "Notification",
      source_pack_key: "notification",
      source_pack_label: "Notification",
      task_refs: ["seq_033"],
      stage: "fill",
      retry_class: "resume_from_checkpoint_only",
      retry_chip_label: "resume_only",
      ...
      live_gate_titles: [
        "Project scope and environment split",
        "Controlled resend and repair policy",
      ...
      harness_paths: [
        "/Users/test/Code/V/tools/browser-automation/notification-project-dry-run.spec.js",
      ],
      selector_refs: [
        "field_vendor",
        "field_project_scope",
      ...
      summary:
        "Resume the notification project draft from the last stable checkpoint so scope, repair posture, and sender identity stay aligned.",
      mock_now_execution:
        "Use the dry-run studio to rehearse scope and sender choices while leaving the live posture blocked.",
      actual_provider_strategy_later:
        "Real account or project work later must reuse the same checkpoint and environment split.",
      completion_evidence: [
      ...
      redaction_policy:
        "Masked draft captures only. Sender refs may appear as identity handles, never raw credentials or tokens.",
      max_auto_retries: 0,
      backoff_posture: "no_blind_retry_resume_only",
      screenshot_policy: "masked_stills_allowed_before_commit",
      trace_policy: "trace_until_checkpoint_only",
      ...
      idempotent: false,
      source_refs: [
        "/Users/test/Code/V/data/analysis/33_notification_studio_pack.json",
        "phase-2-identity-and-echoes.md#2F. Caller verification, voice capture, transcript stub, and SMS continuation",
    ...
    },
    {
      ...
      approval_lanes: ["Ownership / rehearsal", "Vendor service desk"],
      live_gate_status: "blocked",
      live_gate_ids: [
      ...
      live_gate_titles: [
        "Sender ownership pack",
        "Domain or sender verification evidence",
        "Signed webhook and replay fence pack",
      ],
      required_env: [
        "NOTIFICATION_VENDOR_ID",
        "NOTIFICATION_NAMED_APPROVER",
      ...
      summary:
        "Capture the minimum evidence that sender or domain verification is ready, then stop for manual DNS or ownership work.",
      mock_now_execution:
        "Rehearse sender/domain readiness without trying to complete real verification.",
      actual_provider_strategy_later:
        "Later DNS or sender verification completes outside the repo and must not be replayed from browser automation.",
      completion_evidence: [
      ...
      redaction_policy:
        "Only masked stills are allowed. DNS tokens, webhook secrets, and raw sender identifiers must be obscured.",
      max_auto_retries: 0,
      backoff_posture: "stop_after_capture",
      screenshot_policy: "only_masked_approved_stills",
      trace_policy: "trace_off_har_off",
    ...
    },
    {
      ...
      provider_family_label: "Evidence processing",
      source_pack_key: "evidence",
      source_pack_label: "Evidence processing",
      task_refs: ["seq_035"],
      stage: "fill",
      retry_class: "resume_from_checkpoint_only",
      retry_chip_label: "resume_only",
      ...
      approval_lanes: ["Safety / privacy assurance", "Environment approval"],
      live_gate_status: "review_required",
      live_gate_ids: [
      ...
      live_gate_titles: [
        ...
        "Bucket or storage scope is declared",
        "Quarantine policy is frozen",
      ],
      required_env: [
      ...
      harness_paths: [
        "/Users/test/Code/V/tools/browser-automation/evidence-processing-project-dry-run.spec.js",
      ],
      selector_refs: [
        "EVIDENCE_REGION_POLICY_REF",
        "EVIDENCE_RETENTION_POLICY_REF",
      ...
      summary:
        "Resume provider project setup from the current checkpoint so region, retention, storage, and quarantine posture stay bound together.",
      mock_now_execution:
        "Fill the evidence-processing project draft and stop before any live create action.",
      actual_provider_strategy_later:
        "Later live setup must resume from the stored draft receipt and reuse the same evidence bundle.",
      completion_evidence: [
      ...
      redaction_policy:
        "Masked draft captures only. Storage names and project identifiers may appear only when approved and non-secret.",
      max_auto_retries: 0,
      backoff_posture: "no_blind_retry_resume_only",
      screenshot_policy: "masked_stills_allowed_before_commit",
      trace_policy: "trace_until_checkpoint_only",
      ...
      idempotent: false,
      source_refs: [
        "/Users/test/Code/V/data/analysis/35_evidence_processing_lab_pack.json",
        "phase-2-identity-and-echoes.md#2E. Telephony call-session ingestion, evidence readiness, and convergence",
        "phase-2-identity-and-echoes.md#2F. Caller verification, voice capture, transcript stub, and SMS continuation",
    ...
    },
    {
      ...
      live_gate_titles: [
        ...
        "ALLOW_REAL_PROVIDER_MUTATION is true",
      ],
      required_env: [
        "EVIDENCE_PROVIDER_VENDOR_ID",
        "EVIDENCE_PROJECT_SCOPE",
      ...
      summary:
        "Treat webhook-secret entry and secret-backed callback wiring as a redaction-first evidence capture step.",
      mock_now_execution:
        "Use placeholder secret refs and keep traces, HAR, and console output scrubbed.",
      actual_provider_strategy_later:
        "Later live setup may proceed only with a vault receipt, current evidence bundle, and explicit live approval.",
      completion_evidence: [
      ...
      redaction_policy:
        "Traces and HAR stay off. Console logs must be scrubbed. Masked stills are allowed only with redaction proof.",
      max_auto_retries: 0,
      backoff_posture: "manual_secret_reentry_only",
      screenshot_policy: "redaction_proven_then_masked_stills_only",
      trace_policy: "trace_off_har_off_console_scrubbed",
    ...
    },
    {
      ...
      provider_family_label: "Pharmacy",
      source_pack_key: "pharmacy",
      source_pack_label: "Pharmacy",
      task_refs: ["seq_037"],
      stage: "read",
      retry_class: "safe_read_retry",
      retry_chip_label: "safe_read_retry",
      ...
      approval_lanes: ["Ownership / rehearsal"],
      live_gate_status: "pass",
      live_gate_ids: [
      ...
      live_gate_titles: [
        "Pharmacy provider scorecards are approved",
        "Transport scorecards and message-route evidence are approved",
      ],
      required_env: [
        "ALLOW_REAL_PROVIDER_MUTATION",
        "PHARMACY_MVP_REF",
      ...
      harness_paths: [
        "/Users/test/Code/V/tools/browser-automation/pharmacy-access-path-discovery-dry-run.spec.js",
      ],
      selector_refs: ["row_service_search", "row_update_record", "row_manual_fallback"],
      summary:
        "Review directory, Update Record, and manual fallback evidence without trying to open a live pharmacy route.",
      mock_now_execution:
        "Use the route observatory to inspect transport and fallback posture only.",
      actual_provider_strategy_later:
        "The same read-only evidence review runs before any later provider claim so route selection starts from current facts.",
      completion_evidence: [
      ...
      redaction_policy:
        "Masked stills are allowed; route data is not secret, but practice-specific identifiers still need masking if present.",
      max_auto_retries: 2,
      backoff_posture: "short_linear_backoff",
      screenshot_policy: "masked_stills_allowed",
      trace_policy: "trace_allowed_without_secrets",
      ...
      idempotent: true,
      source_refs: [
        "/Users/test/Code/V/data/analysis/pharmacy_referral_transport_decision_register.json",
    ...
    },
    {
      ...
      approval_lanes: ["Environment approval", "Ownership / rehearsal"],
      live_gate_status: "blocked",
      live_gate_ids: [
      ...
      live_gate_titles: [
        "Credible pharmacy MVP is approved",
        "Named approver and target environment are present",
        "ALLOW_REAL_PROVIDER_MUTATION is true",
        "Gap and watch register is clear for the attempted route",
        "Update Record assured combination is named",
      ],
      required_env: [
        "ALLOW_REAL_PROVIDER_MUTATION",
        "PHARMACY_MVP_REF",
      ...
      summary:
        "Choosing and opening a live dispatch route is a non-idempotent mutation that must never be replayed automatically.",
      mock_now_execution:
        "Keep the dispatch route in mock-only or watch posture and stop before any live claim.",
      actual_provider_strategy_later:
        "A live route commit later must capture one transport tuple receipt and escalates to human reconciliation on ambiguity.",
      completion_evidence: [
      ...
      redaction_policy:
        "Commit-phase screenshots are disabled unless an explicitly approved masked still is required for audit.",
      max_auto_retries: 0,
      backoff_posture: "manual_reconciliation_only",
      screenshot_policy: "no_commit_screenshots_without_approval",
      trace_policy: "trace_off_har_off",
      ...
      source_refs: [
        ...
        "seq_037",
        "route_commit_dispatch",
      ],
      evidence_freshness_window_days: 14,
      live_gate_required: true,
    },
    {
      checkpoint_id: "CHK_021",
      ...
      approval_lanes: ["Ownership / rehearsal", "Safety / privacy assurance"],
      live_gate_status: "blocked",
      live_gate_ids: [
      ...
      live_gate_titles: [
        "Urgent return ownership and rehearsal are current",
        "Phase 0 external foundation gate is open",
      ],
      required_env: [
        "ALLOW_REAL_PROVIDER_MUTATION",
        "PHARMACY_MVP_REF",
      ...
      summary:
        "Collect proof that the urgent-return safety net is owned and rehearsed, then stop without trying to automate the manual path itself.",
      mock_now_execution:
        "Model the manual urgent-return lane and store rehearsal references only.",
      actual_provider_strategy_later:
        "Later live widening still depends on the manual safety net staying current and human-owned.",
      completion_evidence: [
      ...
      redaction_policy:
        "Only masked stills of rehearsal metadata are allowed. No patient, clinician, or mailbox content belongs in captures.",
      max_auto_retries: 0,
      backoff_posture: "stop_after_capture",
      screenshot_policy: "only_masked_approved_stills",
      trace_policy: "trace_off_har_off",
    ...
    },
    {
      ...
      provider_family_label: "NHS App",
      source_pack_key: "nhs_app",
      source_pack_label: "NHS App",
      ...
      approval_lanes: ["Sponsor / commercial", "Environment approval"],
      live_gate_status: "review_required",
      live_gate_ids: [
      ...
      live_gate_titles: [
        "NHS login readiness sufficient for NHS App progression",
        "Patient-facing eligibility explicit",
        "Demo environment and demo-readiness current",
      ],
      required_env: [
      ...
      harness_paths: [
        "/Users/test/Code/V/tools/browser-automation/nhs-app-eoi-and-environment-dry-run.spec.js",
        "/Users/test/Code/V/tools/browser-automation/site-link-registration-dry-run.spec.js",
      ],
      selector_refs: ["stage_rail", "mode_toggle_actual", "release_page_tab"],
      summary:
        "Resume the NHS App EOI and environment pack from the last stable checkpoint so scope, demo, and eligibility evidence stay aligned.",
      mock_now_execution: "Use the stage progression studio and stop before any real submit path.",
      actual_provider_strategy_later:
        "A live EOI later must continue from the same scope-bound draft rather than being rebuilt from memory.",
      completion_evidence: [
      ...
      redaction_policy:
        "Masked draft captures only. Any service identifiers or unpublished scope text must be obscured.",
      max_auto_retries: 0,
      backoff_posture: "no_blind_retry_resume_only",
      screenshot_policy: "masked_stills_allowed_before_commit",
      trace_policy: "trace_until_checkpoint_only",
      ...
      idempotent: false,
      source_refs: [
        "/Users/test/Code/V/data/analysis/nhs_app_live_gate_checklist.json",
    ...
    },
    {
      ...
      live_gate_titles: [
        "Commissioning posture explicit",
        "Accessibility evidence current",
        "Design readiness current",
        "Service desk and incident posture current",
        "Named approver present",
        "Environment target present",
      ...
      summary:
        "Commissioning, accessibility, design readiness, and service posture require named review before the NHS App path can widen.",
      mock_now_execution:
        "Model the gate board and capture the evidence gaps, then stop for review.",
      actual_provider_strategy_later:
        "Later real onboarding must reject blind progression unless commissioning and assurance evidence are current and explicitly approved.",
      completion_evidence: [
      ...
      redaction_policy:
        "Only masked stills of the gate board are allowed. No unpublished service data or live credentials belong in captures.",
      max_auto_retries: 0,
      backoff_posture: "stop_and_queue_review",
      screenshot_policy: "masked_stills_only",
      trace_policy: "trace_disabled_by_default",
  ...
  provider_profiles: [
    {
      ...
      source_pack_key: "nhs_login",
      source_pack_label: "NHS login",
      payload_path: "/Users/test/Code/V/data/analysis/nhs_login_capture_pack.json",
      required_env: [
        "NHS_LOGIN_NAMED_APPROVER",
        "NHS_LOGIN_ENVIRONMENT_TARGET",
        "ALLOW_REAL_PROVIDER_MUTATION",
      ...
      review_gate_ids: ["LIVE_GATE_REDIRECT_URI_REVIEW", "LIVE_GATE_TECHNICAL_CONFORMANCE_PENDING"],
      pass_gate_ids: ["LIVE_GATE_IDENTITY_SESSION_PARITY"],
      ...
      sensitive_action_keys: [
        "act_nhs_login_redirect_registration_review",
        "act_nhs_login_credential_promotion",
      ],
      approval_lanes: ["Environment approval", "Safety / privacy assurance"],
      evidence_bundle_examples: [
        "Fresh gate snapshot stamped with the capture date",
        "Official label checks still match the current NHS login guidance",
        "Named redirect review reference linked to the active route family",
        "Scope approval reference tied to the same environment target",
    ...
    },
    {
      ...
      source_pack_key: "gp",
      source_pack_label: "GP systems / IM1",
      payload_path: "/Users/test/Code/V/data/analysis/gp_provider_decision_register.json",
      required_env: [
        "ALLOW_REAL_PROVIDER_MUTATION",
        "GP_PROVIDER_ARCHITECTURE_DIAGRAM_REF",
        "GP_PROVIDER_BOOKING_MVP_REF",
      ...
      review_gate_ids: ["LIVE_GATE_ARCHITECTURE_AND_DATA_FLOW_CURRENT"],
      pass_gate_ids: [
        "LIVE_GATE_PROVIDER_PATH_EVIDENCE_PUBLISHED",
        "LIVE_GATE_APPROVED_PROVIDER_SCORECARDS",
      ],
      ...
      sensitive_action_keys: [
        "act_im1_prerequisite_pack_draft",
        "act_im1_supported_test_admissibility_review",
        "act_im1_license_signatory_handoff",
        "act_im1_submission_commit",
      ],
      approval_lanes: [
        "Sponsor / commercial",
        "Signatory",
    ...
    },
    {
      ...
      source_pack_key: "im1",
      source_pack_label: "IM1 rehearsal",
      payload_path: "/Users/test/Code/V/data/analysis/im1_pairing_pack.json",
      required_env: [
        "IM1_NAMED_APPROVER",
        "IM1_ENVIRONMENT_TARGET",
        "IM1_SPONSOR_NAME",
      ...
      pass_gate_ids: ["LIVE_GATE_IM1_NOT_PHASE2_IDENTITY_SHORTCUT"],
    ...
    },
    {
      ...
      source_pack_key: "pds",
      source_pack_label: "PDS",
      payload_path: "/Users/test/Code/V/data/analysis/pds_access_pack.json",
      required_env: [
        "PDS_NAMED_APPROVER",
        "PDS_ENVIRONMENT_TARGET",
        "PDS_ORGANISATION_ODS",
      ...
      pass_gate_ids: ["PDS_LIVE_GATE_USE_CASE_TRACEABLE", "PDS_LIVE_GATE_ROUTE_FLAG_DEFAULT_OFF"],
      blocked_gate_count: 5,
      review_gate_count: 6,
      pass_gate_count: 2,
      dry_run_harnesses: [
      ...
      sensitive_action_keys: ["act_pds_use_case_pack_draft", "act_pds_legal_basis_review"],
      approval_lanes: ["Legal / governance", "Safety / privacy assurance", "Environment approval"],
      evidence_bundle_examples: [
        "Draft receipt linked to the chosen access mode",
        "Current hazard and risk log references attached to the same draft",
        "Named legal or governance approval reference",
    ...
    },
    {
      ...
      source_pack_key: "mesh",
      source_pack_label: "MESH",
      payload_path: "/Users/test/Code/V/data/analysis/mesh_execution_pack.json",
      required_env: [
        "MESH_NAMED_APPROVER",
        "MESH_ENVIRONMENT_TARGET",
        "MESH_MAILBOX_OWNER_ODS",
      ...
      review_gate_ids: [
        "MESH_LIVE_GATE_OWNER_ODS_KNOWN",
        "MESH_LIVE_GATE_MANAGER_MODE_DECIDED",
        "MESH_LIVE_GATE_MESH_TEAM_LIAISON_READY",
        "MESH_LIVE_GATE_MINIMUM_NECESSARY_REVIEW",
      ],
      pass_gate_ids: [
      ...
      pass_gate_count: 2,
      dry_run_harnesses: [
        "/Users/test/Code/V/tools/browser-automation/mesh-mailbox-dry-run.spec.js",
      ],
      selector_hints: {
        base_profile: {
          mode_toggle_actual: "[data-testid='mode-toggle-actual']",
      ...
      sensitive_action_keys: [
        "act_mesh_mailbox_application_draft",
        "act_mesh_workflow_request_submit",
      ],
      approval_lanes: ["Vendor service desk", "Safety / privacy assurance", "Environment approval"],
      evidence_bundle_examples: [
        "Application draft receipt linked to the mailbox row",
        "Current owner ODS and minimum-necessary review refs on the same draft",
        "Workflow request or mailbox ticket id",
    ...
    },
    {
      ...
      source_pack_key: "telephony",
      source_pack_label: "Telephony",
      payload_path: "/Users/test/Code/V/data/analysis/32_telephony_lab_pack.json",
      required_env: [
        "TELEPHONY_VENDOR_ID",
        "TELEPHONY_NAMED_APPROVER",
        "TELEPHONY_TARGET_ENVIRONMENT",
      ...
      pass_gate_ids: ["TEL_LIVE_GATE_WORKSPACE_OWNERSHIP"],
      blocked_gate_count: 5,
      review_gate_count: 4,
      pass_gate_count: 1,
      dry_run_harnesses: [
      ...
      sensitive_action_keys: [
        "act_telephony_account_project_draft",
        "act_telephony_number_purchase",
      ],
      approval_lanes: ["Environment approval", "Safety / privacy assurance", "Vendor service desk"],
      evidence_bundle_examples: [
        "Draft receipt for the chosen vendor and number profile",
        "Current recording policy and webhook security refs attached to the same draft",
        "Provider number or purchase receipt",
    ...
    },
    {
      ...
      source_pack_key: "notification",
      source_pack_label: "Notification",
      payload_path: "/Users/test/Code/V/data/analysis/33_notification_studio_pack.json",
      required_env: [
        "NOTIFICATION_VENDOR_ID",
        "NOTIFICATION_NAMED_APPROVER",
        "NOTIFICATION_TARGET_ENVIRONMENT",
      ...
      pass_gate_ids: ["LIVE_GATE_NOTIFY_VENDOR_APPROVED"],
      blocked_gate_count: 6,
      review_gate_count: 5,
      pass_gate_count: 1,
      dry_run_harnesses: [
      ...
      sensitive_action_keys: [
        "act_notification_project_draft",
        "act_notification_sender_domain_verification",
      ],
      approval_lanes: ["Environment approval", "Vendor service desk", "Ownership / rehearsal"],
      evidence_bundle_examples: [
        "Project draft receipt for the chosen provider family",
        "Current repair, migration, and scope references bound to the same draft",
        "Ownership or DNS handoff reference",
    ...
    },
    {
      ...
      source_pack_key: "evidence",
      source_pack_label: "Evidence processing",
      payload_path: "/Users/test/Code/V/data/analysis/35_evidence_processing_lab_pack.json",
      required_env: [
        "EVIDENCE_PROVIDER_VENDOR_ID",
        "EVIDENCE_PROJECT_SCOPE",
        "EVIDENCE_TARGET_ENVIRONMENT",
      ...
      pass_gate_ids: ["LIVE_GATE_EVIDENCE_SHORTLIST_APPROVED"],
      blocked_gate_count: 5,
      review_gate_count: 5,
      pass_gate_count: 1,
      dry_run_harnesses: [
      ...
      sensitive_action_keys: [
        "act_evidence_vendor_project_draft",
        "act_evidence_webhook_secret_capture",
      ],
      approval_lanes: ["Safety / privacy assurance", "Environment approval"],
      evidence_bundle_examples: [
        "Draft receipt for the chosen provider and project scope",
    ...
    },
    {
      ...
      review_gate_ids: ["LIVE_GATE_PHARMACY_CONSENT_AND_DISPATCH_MODELS_IMPLEMENTED"],
      pass_gate_ids: [
        "LIVE_GATE_PHARMACY_PROVIDER_SCORECARDS_APPROVED",
        "LIVE_GATE_PHARMACY_TRANSPORT_SCORECARDS_APPROVED",
      ],
      ...
      selector_hints: {
        ...
        official_label_checks: {
          service_search_v3: ["Version 3", "2 February 2026"],
          ...
          gp_connect_news: ["Update Record", "community pharmacy"],
        },
        selector_map: {
          base_profile: {
      ...
      sensitive_action_keys: [
        "act_pharmacy_dispatch_route_commit",
        "act_pharmacy_manual_urgent_return_rehearsal",
      ],
      approval_lanes: [
        "Ownership / rehearsal",
        "Environment approval",
    ...
    },
    {
      ...
      source_pack_key: "nhs_app",
      source_pack_label: "NHS App",
      payload_path: "/Users/test/Code/V/data/analysis/nhs_app_live_gate_checklist.json",
      required_env: [
        "NHS_APP_NAMED_APPROVER",
        "NHS_APP_ENVIRONMENT_TARGET",
        "ALLOW_REAL_PROVIDER_MUTATION",
      ...
      sensitive_action_keys: [
        "act_nhs_app_scope_and_eoi_draft",
        "act_nhs_app_commissioning_gate_review",
      ],
      approval_lanes: [
        "Sponsor / commercial",
        "Environment approval",
