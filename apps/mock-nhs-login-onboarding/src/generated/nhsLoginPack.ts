...
export const nhsLoginPack = {
  "task_id": "seq_024",
  "visual_mode": "Partner_Access_Atelier",
  "mission": "Create one canonical NHS login partner-onboarding rehearsal and gated live-submission pack so Service can exercise product-fit, sandpit readiness, demo readiness, evidence readiness, and later real-provider submission without implying current live eligibility.",
  "captured_at": "2026-04-09T18:02:10",
  "source_precedence": [
    "prompt/024.md",
  ...
  "fields": [
    ...
    },
    {
      ...
      "field_type": "textarea",
      "mock_value": "Service serves patients registered at GP practices in England or receiving NHS services in England.",
    ...
    },
    {
      ...
      "source_refs": [
        ...
        "docs/architecture/05_patient_action_to_route_binding_matrix.md"
      ]
    },
    {
      ...
      "field_type": "textarea",
      "mock_value": "NHS login authenticates the patient and returns claims. Service still decides local session creation, route intent, access grant redemption, writable authority, and same-shell recovery.",
    ...
    },
    {
      ...
      "field_type": "text",
      "mock_value": "Service Partner Access Atelier",
    ...
    },
    {
      ...
      "field_type": "text",
      "mock_value": "https://service.example/mock/callback/nhs-login",
    ...
    },
    {
      ...
      "field_type": "text",
      "mock_value": "PUBKEY_SERVICE_NHS_LOGIN_NONPROD_01",
    ...
    },
    {
      ...
      "field_type": "text",
      "mock_value": "PRIVACY_NOTICE_SERVICE_NHS_LOGIN_DRAFT",
  ...
  "stages": [
    ...
    },
    {
      ...
      "required_checkpoint_ids": [],
      "hard_blockers": [
        "BLOCKER_PRODUCT_DEMO_NOT_YET_HELD"
      ]
    },
    {
      "stage_id": "integration_request_blocked_until_demo",
      ...
      "hard_blockers": [
        "BLOCKER_INTEGRATION_REQUEST_BLOCKED_UNTIL_PRODUCT_DEMO"
      ]
    },
    {
      "stage_id": "integration_request_ready",
    ...
    },
    {
      ...
      "required_checkpoint_ids": [
        "chk_security_privacy_review",
        "chk_clinical_safety_review"
      ],
      "hard_blockers": []
    },
    {
      ...
      "required_field_ids": [
        "fld_connection_signatory",
        "fld_commissioner_posture"
      ],
      "required_artifact_ids": [
        "art_connection_agreement_notes"
      ],
      "required_checkpoint_ids": [
        "chk_special_terms_review",
        "chk_signatory_confirmed"
      ],
      "hard_blockers": [
        "BLOCKER_CONNECTION_AGREEMENT_SIGNATORY_UNKNOWN"
      ]
    },
    {
      "stage_id": "service_desk_registration_pending",
      ...
      "required_field_ids": [
        "fld_service_desk_contacts"
      ],
      "required_artifact_ids": [
        "art_service_desk_registration"
      ],
      "required_checkpoint_ids": [
        "chk_service_desk_registration_review"
      ],
      "hard_blockers": []
    },
    {
      ...
      "required_artifact_ids": [
        "art_selector_map",
        "art_manual_checkpoint_log"
      ],
      "required_checkpoint_ids": [
        "chk_live_submit_pause"
      ],
      "hard_blockers": [
  ...
  "draft_values": {
    ...
    "fld_identity_boundary": "Authentication and consent share happen via NHS login; local session, route intent, grants, and writable authority stay inside Service.",
    ...
    "fld_sandpit_friendly_name": "Service Partner Access Atelier",
    "fld_redirect_uri_primary": "https://service.example/mock/callback/nhs-login",
    "fld_public_key_ref": "PUBKEY_SERVICE_NHS_LOGIN_NONPROD_01",
    ...
    "fld_privacy_notice_ref": "PRIVACY_NOTICE_SERVICE_NHS_LOGIN_DRAFT",
  ...
  "assumptions": [
    {
      ...
      "summary": "Current-stage Service does not yet have a named NHS commissioner or sponsor in repo-backed evidence, so the pack keeps the field explicit and blocks live progression."
    },
    {
