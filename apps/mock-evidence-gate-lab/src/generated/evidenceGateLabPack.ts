export const evidenceGateLabPack = {
  ...
  "shortlisted_vendors": [
    {
      ...
      "notes": "AssemblyAI is strong on job callbacks, EU region selection, and deletion semantics. Like Deepgram, callback trust still needs Service-side replay fencing and trusted re-fetch.",
    ...
    },
    {
      ...
      "notes": "Focused transcription provider with strong async and streaming support. Callback authenticity remains a bounded weakness, so Service must treat callbacks as hints and re-fetch job state before promotion.",
  ...
  "official_vendor_guidance": [
    {
      ...
      "grounding": [
        ...
        "Callback arrival is transport evidence only until Service re-fetches and settles the transcript contract."
      ]
    },
    {
    ...
    },
    {
      ...
      "grounding": [
        ...
        "Service must re-fetch or reconcile job state before promotion."
      ]
    },
    {
  ...
  "project_field_map": {
    "field_rows": [
      ...
      },
      {
        ...
        "requirement_class": "required",
        "placeholder": "x-service-assemblyai-auth",
      ...
      },
      {
        ...
        "notes": "Service-side callback fence.",
        "source_ref": "https://developers.deepgram.com/docs/managing-projects"
      },
      {
      ...
      },
      {
        ...
        "requirement_class": "required",
        "placeholder": "s3://service-evidence-nonprod",
      ...
      },
      {
        ...
        "requirement_class": "required",
        "placeholder": "service-nonprod-evidence",
      ...
      },
      {
        ...
        "requirement_class": "required",
        "placeholder": "eventbridge://service-evidence",
      ...
      },
      {
        ...
        "requirement_class": "review_required",
        "placeholder": "opswat-org://service",
  ...
  "region_policies": [
    {
      ...
      "allowed_vendor_ids": [
        "service_transcript_readiness_twin",
        "service_artifact_quarantine_twin"
      ],
  ...
  "webhook_profiles": [
    ...
    },
    {
      ...
      "transport_model": "https_callback",
      "auth_model": "service_refetch_and_endpoint_control",
    ...
    },
    {
      ...
      "auth_model": "callbackurl_plus_service_ingest_secret",
  ...
  "transcript_scenarios": [
    {
      ...
      "timeline_templates": [
        ...
        },
        {
          ...
          "tone": "neutral",
          "detail": "Service still requires evidence binding and policy checks.",
          "offset_minutes": 4
        }
      ],
