export const pdsAccessPack = {
  ...
  "assumptions": [
    {
      ...
      "summary": "The public PDS pages disclose the onboarding mechanics and required evidence but not a full public form schema for every DOS field. The field map below therefore turns the public mechanics into a deterministic Service dossier structure instead of claiming it is a verbatim portal export.",
    ...
    },
    {
      ...
      "consequence": "Service avoids inventing a fifth baseline mode while still recording the official wording drift."
    },
    {
      ...
      "consequence": "The mock service can simulate update-capable access modes without implying that Service will use them in the current baseline."
    }
  ],
  "upstream_inputs": {
  ...
  "onboarding_fields": [
    {
      ...
      "expected_value": "Service placeholder legal entity",
      "gate_refs": [
        "PDS_LIVE_GATE_USE_CASE_TRACEABLE"
      ]
    },
    ...
    },
    {
      ...
      "expected_value": "Service PDS Optional Enrichment Adapter",
      "gate_refs": [
        "PDS_LIVE_GATE_USE_CASE_TRACEABLE"
      ]
    },
    ...
    },
    {
      ...
      "origin_class": "derived_dossier",
      "official_basis": "Service must bind each PDS use case to exact route families",
    ...
    },
    {
      ...
      "origin_class": "derived_dossier",
      "official_basis": "Service identity law",
  ...
  "hazard_artifacts": [
    ...
    },
    {
      ...
      "gate_refs": "PDS_LIVE_GATE_RISK_LOGS_CURRENT; PDS_LIVE_GATE_ALLOW_REAL_PROVIDER_MUTATION",
      "notes": "Patient access is explicitly current in the official roster and integration guidance, but remains future-only in Service."
    },
    {
  ...
  "mock_service": {
    ...
    "scenarios": [
      ...
      },
      {
        ...
        "description": "Upstream PDS is unavailable or degraded; Service must continue safely without enrichment."
      }
    ],
    "logging_policy": {
