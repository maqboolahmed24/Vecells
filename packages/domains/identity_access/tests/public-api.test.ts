...
describe("public package surface", () => {
  it("boots through public dependencies only", () => {
    expect(packageContract.packageName).toBe("@vecells/domain-identity-access");
    ...
    expect(typeof createDraftAutosaveStore).toBe("function");
    expect(typeof createDraftSessionAutosaveService).toBe("function");
  });
});
